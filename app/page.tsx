...
const projects = [
  ...
  {
    title: "SkyWay",
    description: "A premium flight booking platform featuring a dynamic search engine, multi-step booking wizard with seat selection, and persistent booking history.",
    icon: <ExternalLink className="w-6 h-6 text-purple-400" />,
    tags: ["Next.js", "Tailwind CSS", "Lucide React"],
  },
  {
    title: "Heal",
    description: "A modern music streaming application built with Flutter and Firebase/Supabase, offering high-quality streaming and personalized user experiences.",
    icon: <Smartphone className="w-6 h-6 text-green-400" />,
    tags: ["Flutter", "Firebase", "Supabase"],
  },
  {
    title: "Personal Ledger",
    description: "An offline-friendly Android ledger tool designed for tracking cement-related business transactions, automated balance calculations, and history.",
    icon: <Database className="w-6 h-6 text-emerald-400" />,
    tags: ["Android", "Kotlin", "Google Sheets API"],
  }
];
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#ededed] font-sans selection:bg-purple-500/30 overflow-x-hidden">
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 py-20 md:py-32 flex flex-col gap-32">
        ...
        <section className="flex flex-col gap-8 items-start">
          ...
          >
            ...
            <div className="flex items-center gap-4 px-4">
              <a href="https://github.com/Rahulchouhan28" target="_blank" rel="noreferrer" className="p-3 rounded-full bg-white/5 hover:bg-white/10 transition-colors text-zinc-400 hover:text-white">
        ...
        <footer className="pt-20 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-zinc-500 text-sm">
          <p>© {new Date().getFullYear()} Rahul Chouhan. All rights reserved.</p>
